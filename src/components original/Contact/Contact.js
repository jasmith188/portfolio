        ...
        <div className="contact-jumbotron">
          <div className="contact-row row">
            <div className="col-md-7 text-md-left ml-3 mt-3">
              ...
              <p>I am interested in freelance opportunities - especially ambitious or large projects. However, if you have other requests or questions, don’t hesitate to contact me using the form below either and I'll get back to you as soon as possible.</p>
              <p>
